...
const SearchContactPage = () => {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="bg-white rounded-md border border-gray-300 p-8 mt-5 ">
        <form className="flex flex-col gap-4">
          <div className="flex gap-4">
            <TextArea
              label={"Job Titles (Top 3 Skills)"}
              className="max-h-10"
            />
          ...
          <div className="flex gap-4 items-end">
              ...
              {experience.map((field, index) => (
                <div key={index} className="flex gap-4 mb-2">
                  ...
                  <InputField
                    ...
                    onChange={(e) =>
                      handleInvolvedChange(index, "phone", e.target.value)
                    }
                  />
                  <InputField
                    type="text"
            ...
            <button
              type="button"
              onClick={handleInvolvedField}
              className="text-brand-green font-semibold px-4 py-2 rounded-lg mt-2  mb-2 w-20 cursor-pointer text-nowrap"
            >
              + Add More
            </button>
          </div>
