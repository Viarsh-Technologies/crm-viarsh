...
export const presetQA = {
  "what is project list?": "The project list is a collection of tasks and notes associated with a particular goal or objective.",
...
export const initialChats = [
  ...
  { id: uuidv4(), name: "Meeting Notes", type: 'chat' },
  {
    id: uuidv4(),
    name: "Archived",
    type: 'folder',
